        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <!--<img class="card-img img-fluid" src="<?php echo $data['producto']['imagen_product'];?>" alt="Card image cap" id="product-detail">-->
                        <img class="card-img img-fluid" src="<?php echo BASE_URL . $data['producto']['imagen_product'] ; ?>" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2"><?php echo $data['producto']['nombre_product']?></h1>
                            <p class="h3 py-2"><?php echo MONEDA . ' ' . $data['producto']['precio_product']?></p>
                            <!-- <p class="py-2">
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong><?php echo $data['producto']['categorias']?></strong></p>
                                </li>
                            </ul>

                            <h6>Descripción:</h6>
                            <p><?php echo $data['producto']['descripcion_product']?></p>
                            <!-- <ul class="list-inline">
                                <li class="list-inline-item">
                            ...
                            <form action="" method="GET">
                                ...
                                <div class="row pb-3">
                                    <div class="col d-grid">
                                        <button type="submit" class="btn btn-success btn-lg" name="submit" value="buy">Comprar ya</button>
                                    </div>
                                    <div class="col d-grid">
                        ...
                        <div class="card rounded-0">
                            ...
                            <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                <ul class="list-unstyled">
                                    ...
                                    <li><a class="btn btn-success text-white mt-2 btnAddCarrito" prod="<?php echo $producto['id'];?>"><i class="fas fa-cart-plus"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="card-body">
