...
<div class="container py-5">
    <?php if ($data['verificar']['verify'] == 1) { ?>
        <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="pendientes-tab" data-bs-toggle="tab" data-bs-target="#pendientes-tab-pane" type="button" role="tab" aria-controls="pendientes-tab-pane" aria-selected="false">Pedidos</button>
            </li>
            <!-- <li class="nav-item" role="presentation">
                        ...
                        <div class="card shadow-lg">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <div class="col-12">
                                        <div class="table-responsive">
                                            <table class="table align-middle table-light table-bordered table-striped table-hover" id="tableListaProductos">
                                                <thead>
                                                    <tr>
            ...
            <!-- <div class="tab-pane fade" id="completados-tab-pane" role="tabpanel" aria-labelledby="completados-tab" tabindex="0">
                <div class="col-12">
                    <div class="card shadow-lg">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover" id="tblPedidoComplet" style="width: 100%;">
                                    <thead bg-dark text-white>
                                        <tr>
                                            <th>ID</th>
                                            <th>Monto</th>
...
<div id="modalPedido" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modalPedido" aria-hidden="true">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4 pb-5">
                        <div class="h-100 py-5 services-icon-wap shadow" id="estadoEnviado">
                            ...
                            <h2 class="h5 mt-4 text-center">En proceso de envio</h2>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 pb-5">
                        <div class="h-100 py-5 services-icon-wap shadow" id="estadoProceso">
                            ...
                            <h2 class="h5 mt-4 text-center">Producto Enviado</h2>
                        </div>
                    </div>

                    <div class="col-md-6 col-lg-4 pb-5">
                        <div class="h-100 py-5 services-icon-wap shadow" id="estadoCompletado">
                            <div class="h1 text-success text-center"><i class="fa fa-check"></i></div>
                            <h2 class="h5 mt-4 text-center">Producto recibido</h2>
                        </div>
                    </div>

                    <div class="col-12">
                        <div class="table-responsive">
                            <table class="table table-borderer align-middle table-striped table-hover align-middle" id="tablePedidos" style="width: 100%;">
                                <thead>
                                    <tr>
                                        <th>Producto</th>
                                        <th>Precio</th>
